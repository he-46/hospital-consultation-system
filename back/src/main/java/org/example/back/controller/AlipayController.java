...
/**
 * @Author: adapted for hospital-consultation-system
 * @Description: 支付宝沙箱支付控制器
 */
@RestController
...
public class AlipayController {
     ...
     * @return: org.example.back.common.Result
     **/
    @PostMapping("/pay")
    ...
    */
    ...
    public void returnUrl(HttpServletRequest request,HttpServletResponse response) throws IOException, AlipayApiException {
        ...
        if(signVerified) {
            ...
            // 判断订单号是否以 CONSUL 开头，如果是则为咨询订单
            if (out_trade_no != null && out_trade_no.startsWith("CONSUL")) {
